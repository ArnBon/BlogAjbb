...
<div class="row">
  <form method="POST" action ="{{ route('admin.posts.update', $post) }}">
    {{ csrf_field() }}  {{ method_field('PUT') }} <!--method_field() permite pasar un campo oculto en este caso para PUT que concuerda con el metodo de la ruta llamado put-->
    <div class="col-md-8">
      ...
      <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group {{ $errors->has('body') ? 'has-error' : ''  }}">
              ...
              <textarea rows="10" id="editor" name="body" class="form-control" 
              placeholder="Ingresa un extracto de la publicación">{{ old('body', $post->body) }}</textarea>
   ...
   <script>
    ...
    CKEDITOR.replace( 'editor' );
      ...
      var myDropzone = new Dropzone('.dropzone',{       
        ...
        paramName: 'photo',//cambiamos el nombre del campo que se llama file lo cambiamos por photo
    ...
    myDropzone.on('error', function(file, res){   
      //alert(photo);
        var msg = res.photo;
        $('.data-dz-errormessage:last > span').text(msg);
    });
